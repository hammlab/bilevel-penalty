...
class bilevel_importance_transfer(object):
    ...
    def __init__(self,sess,x_train_tf,x_test_tf,y_train_tf,y_test_tf,
            ...
            batch_size,lr_al,lr_u,lr_v,rho_0,lamb_0,eps_0,c_rho,c_lamb,c_eps):
        ...
        us = [self.importance_atanh,self.var_cls_test]
        vs = [self.var_filt,self.var_cls_train]
        v_flat = self.var_filt + self.var_cls_train
        lr_us = [lr_al,lr_u]
        lr_vs = [lr_v,lr_v]
        
        self.bl = bilevel_penalty(sess,self.f,self.g,us,vs,lr_us,lr_vs,rho_0,lamb_0,eps_0,c_rho,c_lamb,c_eps)
        ...
        self.optim_lower_simple = tf.train.AdamOptimizer(lr_v).minimize(self.loss_lower_simple,var_list=v_flat)
