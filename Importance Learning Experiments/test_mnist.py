...
if True:
    ...
    lr_inner = 1E-3#6*1E-5#1E-4#6*1E-5#1E-5
    '''
    MT:
    1E-3
    Corrupt:
    ...
    for epoch in range(nepochs):
        ...
        for batch in range(nb_batches):
            ...
            l1, l2, timp_atan = blmt.train(X_train[index_shuf[ind],:], Y_train[index_shuf[ind],:], X_val[ind_val,:], Y_val[ind_val,:], importance_atan[index_shuf[ind]])
        ...
        if epoch %1 == 0:
            ...
            print('epoch %d: loss_inner=%f, loss_outer=%f'%(epoch, l1, l2))
